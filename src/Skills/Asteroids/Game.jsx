...
export default class Game {
    constructor(canvas, skills, color, skillConquered, finishGame, registerAnimationFrame, showInfo) {
        this.canvas = canvas
    ...
    generateAsteroid(x, y, radius, type, skillName) {
    ...
    resetAsteroids() {
        this.asteroids.forEach((a) => a.blacklisted = true)
    }
